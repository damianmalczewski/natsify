...
public class NatsListenerExample {
  ...
  public NatsListenerExample(RecordStore recordStore) {
  ...
  public void onRecord(Record measurement) {
    recordStore.add(measurement);
    log.debug("Received telemetry: {}", measurement);
  }
